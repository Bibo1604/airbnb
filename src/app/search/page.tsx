    ...
    return (
        <section>
            <div className='max-w-[2520px] mx-auto xl:px-20 md:px-10 sm:px-2 px-4'>
                ...
                <div className="pt-7 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-8">
                        ...
                        <Link key={i} className="col-span-1 cursor-pointer group" href={"https://www.airbnb.com" + item.link} target="_blank">
                            <div className="flex flex-col gap-1 w-full">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center font-light"><FaStar className="text-black mr-1"/>{item.rating}</div>
                                </div>
